...
export const PROGRAM_TEMPLATES: ProgramTemplate[] = [
  ...
  // ============================================
  {
    ...
    daysPerWeek: 4,
    durationWeeks: 8,
    equipment: ['barbell', 'dumbbells', 'resistance bands', 'cables'],
    goals: ['Build glutes', 'Shape booty', 'Lower body focus'],
    structure: {
      phases: 2,
      splitType: 'Lower Emphasis',
      periodization: 'Linear',
    },
    workoutPreview: [
      {
        day: 1,
        name: 'Glute Focus A',
        focus: 'Hip Thrust Day',
        exercises: ['Hip Thrust', 'Romanian Deadlift', 'Cable Kickbacks', 'Frog Pumps', 'Banded Walks'],
      },
      {
        day: 2,
        name: 'Upper Body',
        focus: 'Maintain Upper',
        exercises: ['Push-ups', 'Rows', 'Shoulder Press', 'Lateral Raises', 'Core'],
      },
      {
        day: 3,
        name: 'Glute Focus B',
        focus: 'Squat Day',
        exercises: ['Sumo Squat', 'Bulgarian Split Squat', 'Glute Bridge', 'Abductors', 'Banded Squats'],
      },
      {
        day: 4,
        name: 'Glute Focus C',
        focus: 'Hinge Day',
        exercises: ['Deadlift', 'Good Mornings', 'Single Leg RDL', 'Cable Pull-throughs', 'Kickbacks'],
      },
    ],
    features: [
      ...
      'Band work for mind-muscle connection',
    ],
    popularityScore: 93,
  },
  {
    ...
    daysPerWeek: 5,
    durationWeeks: 6,
    equipment: ['dumbbells', 'kettlebells', 'cables'],
    goals: ['Lose fat', 'Get toned', 'Summer ready'],
    structure: {
      phases: 2,
      splitType: 'Full Body + HIIT',
      periodization: 'Linear',
    },
    workoutPreview: [
      {
        ...
        exercises: ['Goblet Squat', 'Push-ups', 'Rows', 'Lunges', 'HIIT Finisher'],
      },
      {
        day: 2,
        name: 'Upper Tone',
        focus: 'Arms & Shoulders',
        exercises: ['Shoulder Press', 'Tricep Dips', 'Bicep Curls', 'Lateral Raises', 'Plank'],
      },
      {
        day: 3,
        name: 'Lower Burn',
        focus: 'Legs & Glutes',
        exercises: ['Sumo Deadlift', 'Walking Lunges', 'Hip Thrust', 'Calf Raises', 'HIIT Finisher'],
      },
      {
        day: 4,
        name: 'Core & Cardio',
        focus: 'Abs & Conditioning',
        exercises: ['Dead Bug', 'Russian Twists', 'Mountain Climbers', 'Bicycle Crunches', 'Burpees'],
      },
      {
        day: 5,
        name: 'Total Body HIIT',
        focus: 'Fat Burn',
        exercises: ['KB Swings', 'Thrusters', 'Jump Squats', 'Battle Ropes', 'Sprints'],
      },
    ],
    features: [
  ...
  },
  {
    ...
    goals: ['Tone arms', 'Define shoulders', 'Lean muscle'],
    structure: {
      phases: 2,
      splitType: 'Upper Focus',
      periodization: 'Linear',
    },
    workoutPreview: [
      {
        ...
        exercises: ['Bicep Curls', 'Tricep Kickbacks', 'Hammer Curls', 'Overhead Extensions', 'Dips'],
      },
      {
        day: 2,
        name: 'Lower Body',
        focus: 'Maintain Legs',
        exercises: ['Squats', 'Deadlifts', 'Lunges', 'Calf Raises', 'Core'],
      },
      {
        day: 3,
        name: 'Shoulders',
        focus: 'Defined Delts',
        exercises: ['Shoulder Press', 'Lateral Raises', 'Front Raises', 'Rear Delt Flyes', 'Shrugs'],
      },
      {
        day: 4,
        name: 'Arms B',
        focus: 'Sculpt & Define',
        exercises: ['Concentration Curls', 'Skull Crushers', 'Cable Curls', 'Rope Pushdowns', 'Diamond Push-ups'],
      },
    ],
    features: [
      'High rep toning work',
      'No bulk approach',
      'Shoulder definition focus',
      'Tank top ready arms',
    ],
    popularityScore: 88,
  },
  {
    ...
    goals: ['Flatten stomach', 'Reveal abs', 'Core strength'],
    structure: {
      phases: 2,
      splitType: 'Core Focus + Full Body',
      periodization: 'Linear',
    },
    workoutPreview: [
      {
        ...
        name: 'Core Blast',
        focus: 'Ab Circuit',
        exercises: ['Plank', 'Crunches', 'Leg Raises', 'Russian Twists', 'Dead Bug'],
      },
      {
        day: 2,
        name: 'Full Body Burn',
        focus: 'Fat Loss',
        exercises: ['Squats', 'Push-ups', 'Rows', 'Lunges', 'Mountain Climbers'],
      },
      {
        day: 3,
        name: 'Core & Cardio',
        focus: 'Abs + HIIT',
        exercises: ['Bicycle Crunches', 'V-ups', 'Plank Jacks', 'Burpees', 'High Knees'],
      },
      {
        day: 4,
        name: 'Lower Body',
        focus: 'Legs & Glutes',
        exercises: ['Deadlifts', 'Hip Thrust', 'Walking Lunges', 'Calf Raises', 'Plank'],
      },
      {
        day: 5,
        name: 'Core Finisher',
        focus: 'Ab Burnout',
        exercises: ['Hollow Hold', 'Flutter Kicks', 'Toe Touches', 'Side Plank', 'Ab Wheel'],
      },
    ],
    features: [
      'Daily core work',
  ...
  },
  {
    ...
    daysPerWeek: 4,
    durationWeeks: 10,
    equipment: ['barbell', 'dumbbells', 'leg machines'],
    goals: ['Build leg size', 'Quad development', 'Leg strength'],
    structure: {
      phases: 2,
      splitType: 'Lower Emphasis',
      periodization: 'Linear',
    ...
    workoutPreview: [
      {
        ...
        name: 'Quad Dominant',
        focus: 'Front Thigh',
        exercises: ['Back Squat', 'Leg Press', 'Leg Extensions', 'Walking Lunges', 'Sissy Squats'],
      },
      {
        day: 2,
        name: 'Upper Body',
        focus: 'Maintain Upper',
        exercises: ['Bench Press', 'Rows', 'OHP', 'Pull-ups', 'Arms'],
      },
      {
        day: 3,
        name: 'Hamstring Focus',
        focus: 'Back Thigh',
        exercises: ['Romanian Deadlift', 'Lying Leg Curls', 'Good Mornings', 'Nordic Curls', 'Glute Ham Raise'],
      },
      {
        day: 4,
        name: 'Full Leg Day',
        focus: 'Complete Development',
        exercises: ['Front Squat', 'Hack Squat', 'Bulgarian Split Squat', 'Leg Curls', 'Calf Raises'],
      },
    ],
    features: [
      '3 leg days per week',
  ...
  },
  {
    ...
    durationWeeks: 8,
    equipment: ['dumbbells', 'resistance bands', 'cables'],
    goals: ['Beach ready', 'Toned physique', 'Confident body'],
    structure: {
      phases: 2,
      splitType: 'Full Body Split',
      periodization: 'Linear',
    },
    workoutPreview: [
      {
        day: 1,
        name: 'Glutes & Legs',
        focus: 'Lower Body Tone',
        exercises: ['Hip Thrust', 'Sumo Squat', 'Walking Lunges', 'Cable Kickbacks', 'Calf Raises'],
      },
      {
        day: 2,
        name: 'Arms & Shoulders',
        focus: 'Upper Body Tone',
        exercises: ['Shoulder Press', 'Lateral Raises', 'Bicep Curls', 'Tricep Dips', 'Push-ups'],
      },
      {
        day: 3,
        name: 'Core & Cardio',
        focus: 'Abs & Fat Burn',
        exercises: ['Plank', 'Russian Twists', 'Leg Raises', 'Mountain Climbers', 'HIIT Circuit'],
      },
      {
        day: 4,
        name: 'Full Body Tone',
        focus: 'Total Body',
        exercises: ['Deadlifts', 'Rows', 'Chest Press', 'Squats', 'Core'],
      },
      {
        day: 5,
        name: 'Booty & Abs',
        focus: 'Beach Focus',
        exercises: ['Glute Bridge', 'Fire Hydrants', 'Donkey Kicks', 'Crunches', 'Plank Variations'],
      },
    ],
    features: [
  ...
  },
  {
    ...
    goals: ['Build curves', 'Hourglass shape', 'Waist definition'],
    structure: {
      phases: 2,
      splitType: 'Upper/Lower',
      periodization: 'Linear',
    ...
    workoutPreview: [
      {
        ...
        name: 'Shoulders & Back',
        focus: 'Upper Width',
        exercises: ['Shoulder Press', 'Lateral Raises', 'Face Pulls', 'Rows', 'Rear Delts'],
      },
      {
        day: 2,
        name: 'Glutes & Legs',
        focus: 'Lower Curves',
        exercises: ['Hip Thrust', 'Sumo Deadlift', 'Bulgarian Split Squat', 'Abductors', 'Glute Kickbacks'],
      },
      {
        day: 3,
        name: 'Upper & Core',
        focus: 'Shape & Waist',
        exercises: ['Push-ups', 'Pull-ups', 'Plank', 'Vacuum', 'Oblique Work'],
      },
      {
        day: 4,
        name: 'Glute Focus',
        focus: 'Booty Day',
        exercises: ['Barbell Hip Thrust', 'Cable Pull-throughs', 'Frog Pumps', 'Banded Walks', 'Glute Bridge'],
      },
    ],
    features: [
      'Shoulder width emphasis',
      'Heavy glute focus',
      'Waist-slimming core work',
  ...
  },
  {
    ...
    durationWeeks: 8,
    equipment: ['dumbbells', 'resistance bands'],
    goals: ['Get toned', 'Lean muscle', 'Fit physique'],
    structure: {
      phases: 2,
      splitType: 'Full Body',
      periodization: 'Linear',
    ...
    workoutPreview: [
      {
        ...
        name: 'Full Body A',
        focus: 'Strength + Tone',
        exercises: ['Goblet Squat', 'Push-ups', 'Rows', 'Lunges', 'Plank'],
      },
      {
        day: 2,
        name: 'Cardio & Core',
        focus: 'Fat Burn',
        exercises: ['HIIT Circuit', 'Mountain Climbers', 'Burpees', 'Russian Twists', 'Bicycle Crunches'],
      },
      {
        day: 3,
        name: 'Full Body B',
        focus: 'Strength + Tone',
        exercises: ['Deadlifts', 'Shoulder Press', 'Pull-ups', 'Hip Thrust', 'Core'],
      },
      {
        day: 4,
        name: 'Active Recovery',
        focus: 'Light Movement',
        exercises: ['Yoga Flow', 'Light Cardio', 'Stretching', 'Foam Rolling', 'Mobility'],
      },
    ],
    features: [
      'No bulk approach',
  ...
  },
  {
    ...
    durationWeeks: 12,
    equipment: ['dumbbells', 'cables', 'resistance bands'],
    goals: ['Wedding ready', 'Toned arms', 'Photo ready'],
    structure: {
      phases: 3,
      splitType: 'Full Body Split',
      periodization: 'Block',
    ...
    workoutPreview: [
      ...
      },
      {
        ...
        name: 'Lower Body',
        focus: 'Legs & Glutes',
        exercises: ['Squats', 'Hip Thrust', 'Walking Lunges', 'Deadlifts', 'Calf Raises'],
      },
      {
        day: 3,
        name: 'Back & Posture',
        focus: 'Photo Ready Back',
        exercises: ['Rows', 'Pull-ups', 'Face Pulls', 'Rear Delts', 'Back Extensions'],
      },
      {
        day: 4,
        name: 'Core & Cardio',
        focus: 'Waist Definition',
        exercises: ['Plank', 'Russian Twists', 'Leg Raises', 'HIIT', 'Vacuum'],
      },
      {
        day: 5,
        name: 'Full Body Tone',
        focus: 'Overall Polish',
        exercises: ['Circuit Training', 'Light Weights', 'High Reps', 'Cardio Finisher', 'Stretching'],
      },
    ],
    features: [
  ...
  {
    id: 'new-baby-bounce',
    name: 'New Baby Bounce Back',
    slug: 'new-baby-bounce-back',
    description:
    ...
    durationWeeks: 12,
    equipment: ['dumbbells', 'resistance bands'],
    goals: ['Postpartum recovery', 'Core restoration', 'Safe fitness'],
    structure: {
      phases: 3,
      splitType: 'Full Body',
    ...
    workoutPreview: [
      {
        ...
        exercises: ['Diaphragmatic Breathing', 'Pelvic Floor Activation', 'Gentle Core', 'Glute Bridge', 'Bird Dog'],
      },
      {
        day: 2,
        name: 'Strength',
        focus: 'Rebuild Strength',
        exercises: ['Goblet Squat', 'Push-ups', 'Rows', 'Lunges', 'Plank'],
      },
      {
        day: 3,
        ...
        exercises: ['Deadlift', 'Shoulder Press', 'Hip Hinge', 'Core Work', 'Stretching'],
      },
    ],
    features: [
  ...
  },
  {
    ...
    goals: ['Slim thick physique', 'Build curves', 'Lean waist'],
    structure: {
      phases: 2,
      splitType: 'Lower Emphasis',
      periodization: 'Block',
    ...
    workoutPreview: [
      ...
      },
      {
        ...
        name: 'Upper Tone',
        focus: 'Lean Upper',
        exercises: ['Push-ups', 'Rows', 'Shoulder Press', 'Lateral Raises', 'Triceps'],
      },
      {
        day: 3,
        name: 'Quad & Glute',
        focus: 'Leg Development',
        exercises: ['Squat', 'Bulgarian Split Squat', 'Leg Press', 'Hip Thrust', 'Abductors'],
      },
      {
        day: 4,
        name: 'Core & Cardio',
        focus: 'Waist Work',
        exercises: ['Plank', 'Vacuum', 'HIIT', 'Russian Twists', 'Dead Bug'],
      },
      {
        day: 5,
        name: 'Glute Finisher',
        focus: 'Pump Day',
        exercises: ['Glute Bridge', 'Kickbacks', 'Fire Hydrants', 'Banded Squats', 'Donkey Kicks'],
      },
    ],
    features: [
      'Heavy lower body focus',
      'Waist-minimizing core',
      'Light upper to stay lean',
      'Curve-building split',
    ],
    popularityScore: 90,
  },
  {
    ...
    durationWeeks: 12,
    equipment: ['barbell', 'dumbbells', 'cables', 'resistance bands'],
    goals: ['Glute growth', 'Peach shape', 'Lift and round'],
    structure: {
      phases: 3,
      splitType: 'Glute Specialization',
      periodization: 'Block',
    },
    workoutPreview: [
      {
        ...
        name: 'Thrust Day',
        focus: 'Hip Extension',
        exercises: ['Barbell Hip Thrust', 'Single Leg Hip Thrust', 'Glute Bridge', 'Pull-throughs', 'Frog Pumps'],
      },
      {
        day: 2,
        name: 'Squat Day',
        focus: 'Compound Lower',
        exercises: ['Squat', 'Bulgarian Split Squat', 'Goblet Squat', 'Leg Press', 'Walking Lunges'],
      },
      {
        day: 3,
        name: 'Upper Body',
        focus: 'Maintain Upper',
        exercises: ['Push-ups', 'Rows', 'Shoulder Press', 'Pull-ups', 'Core'],
      },
      {
        day: 4,
        name: 'Pump Day',
        focus: 'Glute Activation',
        exercises: ['Banded Hip Thrust', 'Cable Kickbacks', 'Abductors', 'Fire Hydrants', 'Banded Walks'],
      },
    ],
    features: [
  ...
  },
  {
    ...
    durationWeeks: 8,
    equipment: ['dumbbells', 'resistance bands'],
    goals: ['Start fitness', 'Build habit', 'Get moving'],
    structure: {
      phases: 2,
      splitType: 'Full Body',
      periodization: 'Progressive',
    ...
    workoutPreview: [
      {
        ...
        name: 'Foundation A',
        focus: 'Learn Basics',
        exercises: ['Bodyweight Squat', 'Wall Push-ups', 'Assisted Rows', 'Glute Bridge', 'Plank'],
      },
      {
        day: 2,
        name: 'Foundation B',
        focus: 'Build Strength',
        exercises: ['Goblet Squat', 'Push-ups', 'DB Rows', 'Lunges', 'Core'],
      },
      {
        day: 3,
        name: 'Foundation C',
        focus: 'Full Body',
        exercises: ['Deadlift', 'Shoulder Press', 'Pull-ups Assisted', 'Step-ups', 'Plank'],
      },
    ],
    features: [
  ...
  {
    id: 'muffin-top-melter',
    name: 'Muffin Top Melter',
    slug: 'muffin-top-melter',
    description:
    ...
    durationWeeks: 6,
    equipment: ['dumbbells', 'resistance bands'],
    goals: ['Reduce waist', 'Core strength', 'Fat loss'],
    structure: {
      phases: 2,
      splitType: 'Core Focus + Full Body',
      periodization: 'Linear',
    ...
    workoutPreview: [
      {
        ...
        name: 'Core Blast',
        focus: 'Obliques & Abs',
        exercises: ['Side Plank', 'Russian Twists', 'Bicycle Crunches', 'Wood Chops', 'Dead Bug'],
      },
      {
        day: 2,
        name: 'Full Body Fat Burn',
        focus: 'Calorie Burn',
        exercises: ['Squats', 'Push-ups', 'Rows', 'Lunges', 'HIIT Circuit'],
      },
      {
        day: 3,
        name: 'Core & Cardio',
        focus: 'Abs + HIIT',
        exercises: ['Plank', 'Mountain Climbers', 'Leg Raises', 'Burpees', 'High Knees'],
      },
      {
        day: 4,
        name: 'Lower Body',
        focus: 'Legs & Glutes',
        exercises: ['Deadlifts', 'Hip Thrust', 'Walking Lunges', 'Calf Raises', 'Core'],
      },
      {
        day: 5,
        name: 'Cardio Finisher',
        focus: 'Fat Burn',
        exercises: ['HIIT', 'Jump Rope', 'Shadow Boxing', 'Sprints', 'Cool Down'],
      },
    ],
    features: [
      'Oblique targeting',
      'HIIT fat burning',
      'Waist reduction focus',
      '6-week program',
    ],
    popularityScore: 84,
  },
  {
    ...
    durationWeeks: 8,
    equipment: ['dumbbells', 'resistance bands'],
    goals: ['Time efficient', 'Home workouts', 'Mom fitness'],
    structure: {
      phases: 2,
      splitType: 'Full Body',
      periodization: 'Linear',
    ...
    workoutPreview: [
      {
        day: 1,
        name: '20-Min Burn',
        focus: 'Quick Full Body',
        exercises: ['Squats', 'Push-ups', 'Rows', 'Lunges', 'Plank'],
      },
      {
        day: 2,
        name: '20-Min Core',
        focus: 'Abs & Cardio',
        exercises: ['Dead Bug', 'Bird Dog', 'Plank', 'Mountain Climbers', 'Russian Twists'],
      },
      {
        day: 3,
        name: '20-Min Lower',
        focus: 'Legs & Glutes',
        exercises: ['Glute Bridge', 'Sumo Squat', 'Lunges', 'Calf Raises', 'Hip Thrust'],
      },
      {
        day: 4,
        name: '20-Min Upper',
        focus: 'Arms & Back',
        exercises: ['Push-ups', 'Rows', 'Shoulder Press', 'Bicep Curls', 'Tricep Dips'],
      },
    ],
    features: [
      '20-minute workouts',
      'Home friendly',
      'Quiet exercise options',
      'Flexible scheduling',
    ],
    popularityScore: 83,
  },
  {
    id: 'strong-not-skinny',
    name: 'Strong Not Skinny',
    slug: 'strong-not-skinny',
    description:
    ...
    durationWeeks: 12,
    equipment: ['barbell', 'dumbbells', 'cables'],
    goals: ['Build strength', 'Gain muscle', 'Empowerment'],
    structure: {
      phases: 3,
      splitType: 'Upper/Lower',
      periodization: 'Linear',
    ...
    workoutPreview: [
      {
        ...
        name: 'Upper Strength',
        focus: 'Heavy Upper',
        exercises: ['Bench Press', 'Rows', 'OHP', 'Pull-ups', 'Face Pulls'],
      },
      {
        day: 2,
        name: 'Lower Strength',
        focus: 'Heavy Lower',
        exercises: ['Squat', 'Romanian Deadlift', 'Hip Thrust', 'Leg Press', 'Calf Raises'],
      },
      {
        day: 3,
        name: 'Upper Volume',
        focus: 'Build Muscle',
        exercises: ['Incline Press', 'Cable Rows', 'Lateral Raises', 'Biceps', 'Triceps'],
      },
      {
        day: 4,
        name: 'Lower Volume',
        focus: 'Build Curves',
        exercises: ['Deadlift', 'Bulgarian Split Squat', 'Leg Curls', 'Glute Bridge', 'Calves'],
      },
    ],
    features: [
      'Strength focused',
