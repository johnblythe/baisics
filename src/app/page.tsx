    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="pt-16">
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {/* Hero Section */}
          <div className="relative flex flex-col lg:flex-row items-center justify-between py-20 gap-12">
            {/* Background Texture */}
        ...
        {/* Built for You Section - Full Width */}
        <div className="relative py-32 w-full overflow-hidden border-t border-b border-gray-100">
        ...
        {/* Work Smarter Section - Full Width */}
        ...
        {/* Cut the Shit Section - Full Width */}
        <div className="relative py-32 w-full overflow-hidden bg-gradient-to-b from-transparent via-indigo-50/30 to-transparent">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(99,102,241,0.05),transparent_70%)]"></div>
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col lg:flex-row items-center gap-12">
              {/* Left Content */}
              <div className="flex-1 space-y-8">
                ...
                {/* <div className="p-8 bg-white/80 backdrop-blur-sm rounded-xl border border-gray-100 shadow-sm"> */}
                  <p className="text-lg text-gray-600">
                    Great trainers can cost you $100-400 a month. A nutritionist will set you back another $100-200 per visit. Hunting down the best information online takes dozens if not hundreds of hours. We&pos;ll do the work there so you can do the work that matters.
                  </p>
        ...
        {/* Zero Risk Section - Full Width */}
        <div className="relative py-32 bg-indigo-50/30 w-full overflow-hidden border-2 border-gray-200">
          ...
          <div className="relative max-w-[120rem] mx-auto px-4 sm:px-6 lg:px-8 text-center rounded-lg">
            ...
            <p className="text-xl font-bold text-indigo-600 uppercase tracking-[0.2em] mb-12">
              ...
              <h2 className="text-6xl sm:text-7xl lg:text-[10rem] font-bold mb-24 text-indigo-600 leading-[0.9]">
