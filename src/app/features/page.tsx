...
const MORE_FEATURES = [
  ...
  },
  {
    ...
    title: 'Food Logging & Nutrition',
    description: 'Log meals with smart fuzzy search across a verified food database. Track daily macros against your targets. Paste any plain-text recipe and get an instant nutritional breakdown.',
    screenshot: '/features/nutrition-tracking.png',
    category: 'Nutrition',
  },
  {
    id: 'meal-prep',
    title: 'Meal Plans & Carb Cycling',
    description: 'Generate meal plans that hit your macros. Jacked members get carb cycling with auto-calculated training and rest day targets, dietary filters, and shopping lists.',
