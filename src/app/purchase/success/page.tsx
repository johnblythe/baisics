...
function PurchaseSuccess() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <Header />
      <main className="flex-grow bg-gradient-to-b from-white via-[#FFE5E5]/30 to-white dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 pt-16">
        <div className="max-w-4xl mx-auto px-4 py-16 sm:px-6 lg:px-8">
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 md:p-12">
            {isProcessing ? (
              <div className="text-center">
                <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-[#FF6B6B] dark:border-[#FF6B6B] mx-auto mb-4"></div>
              ...
              <div className="text-center">
                ...
                <button
                  ...
                  className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-[#FF6B6B] dark:bg-[#FF6B6B] hover:bg-[#EF5350] dark:hover:bg-[#EF5350] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#FF6B6B] dark:focus:ring-offset-gray-900"
                >
                  Return to Dashboard
                </button>
              </div>
